...
```
[<project>] [<emoji> #c<convoId>] *<chủ đề>:*
...
- **Emoji:** MUST use the fixed emoji for your identity (e.g., 🌌 for Antigravity, ⚛️ for Codex, 🟧 for Claude) to quickly identify who is sending. Do NOT add the agent name.
- **Topic:** ≤ 9 words.
...
Inline (default):
```bash
node ../teleport/scripts/send-telegram.mjs "⚛️ *Sửa loop:*
